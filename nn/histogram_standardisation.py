...
def create_database_perc_dir(mask_type, list_paths, modality, cutoff,
    ...
    for p in list_patients:
        ...
        # p = list_patients[i]
        file_img = util.create_list_modalities_available(list_paths, p)
...
def create_database_perc(img_names, mask_names, cutoff, type_hist='quartile'):
    perc_database = None
    cutoff = standardise_cutoff(cutoff, type_hist)
...
def affine_transf(value, lin, affine):
    return lin * value + affine
