...
class SegmentationApplication(BaseApplication):
  def __init__(self,net_class, param, volume_loader):
    ...
    self._loss_func = LossFunction(n_class=self._param.num_classes,loss_type=self._param.loss_type)
  ...
  def loss_func(self,train_dict,net_outputs):
    if "weight_maps" in train_dict:
      ...
      weight_maps = None
    return self._loss_func(net_outputs, train_dict['Sampling/labels'], weight_maps)
