...
def build_parser(parents, defaults):
    ...
    parser.add_argument(
        "--conditioning_size",
        metavar='',
        help="Set size of conditioning data",
        type=int,
        default=-1
    )
    parser.add_argument(
        "--noise_size",
        metavar='',
        help="Set number of noise dimensions",
        type=int,
    ...
    parser.add_argument(
        "--conditioning_interp_order",
        help="interpolation order when resampling sonditioning data",
        type=int,
        default=0
    )
    parser.add_argument(
...
def run():
    ...
    if file_arg.conf:
        ...
        image_matcher, conditioning_matcher = _input_path_search(config)
    ...
    csv_dict = {'input_image_file': image_csv_path,
                'target_image_file': conditioning_csv_path,
