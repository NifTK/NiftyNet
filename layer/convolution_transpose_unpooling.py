...
class ConvTransUnpoolLayer(TrainableLayer):
    """
    This class defines a simple transpose convolution unpooling with an optional bias term.
    ...
    def __init__(self,
                 ...
                 b_regularizer=None,
                 name='conv'):
        super(ConvTransUnpoolLayer, self).__init__(name=name)
...
class ConvolutionalTransposeUnpoolingLayer(TrainableLayer):
    """
    This class defines a composite layer with optional components:
        transpose convolution -> batch_norm -> activation -> dropout
    The b_initializer and b_regularizer are applied to the ConvTransUnpoolLayer
    The w_initializer and w_regularizer are applied to the ConvTransUnpoolLayer,
    ...
    def __init__(self,
        ...
        super(ConvolutionalTransposeUnpoolingLayer, self).__init__(name=self.layer_name)

        # for ConvTransUnpoolLayer
        self.n_output_chns = n_output_chns
    ...
    def layer_op(self, input_tensor, is_training=None, keep_prob=None):
        conv_trans_layer = ConvTransUnpoolLayer(n_output_chns=self.n_output_chns,
