...
class ResamplerTest(tf.test.TestCase):
    ...
    def get_identity_warp(self):
        ...
        return grid,params
    def _test_correctness(self,input,grid,interpolation,boundary,expected_value):
        resampler=ResamplerLayer(interpolation=interpolation,boundary=boundary)
    ...
    def test_resampler_3d_replicate_nearest_correctness(self):
        self._test_correctness(input=self.get_3d_input2(),
                               ...
                               boundary='REPLICATE',
                               expected_value=[[[1,101],[3,103]],[[13,113],[10,110]]])
