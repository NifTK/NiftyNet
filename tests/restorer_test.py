...
class RestorerTest(tf.test.TestCase):
    ...
    def test_no_restores(self):
        tf.reset_default_graph()
        block1 = ConvolutionalLayer(4, 3, name='bar', bn_type=None,
                                    w_initializer=tf.constant_initializer(1.))
